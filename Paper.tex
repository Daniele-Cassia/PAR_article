...
A estrutura do projeto é organizada de maneira a facilitar a manutenção e a expansão 
do mesmo.
...
Para a integração e entrega contínua (CI/CD), o projeto utiliza ferramentas como 
